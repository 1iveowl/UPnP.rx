...
*(An earlier revision listed a tenth entry here that was ours, not upstream. It has moved to the 5.1 shelf in [upnp-rx-v5.0-plan.md §12](upnp-rx-v5.0-plan.md) - this list is for gaps in the sibling libraries only, per the §3 rule.)*
